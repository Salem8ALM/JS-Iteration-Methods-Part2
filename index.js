...
******************************************************************/
const totalIncome = income.reduce((total, number) => total + number[1], 0);
const totalExpense = expense.reduce((total, number) => total + number[1], 0);
...
const transactionsAboveOrEqualFiveHundred = transactions.filter(
  (transaction) => transaction[1] >= 500
);
console.log(netTotal);
console.log(transactionsAboveOrEqualFiveHundred);
